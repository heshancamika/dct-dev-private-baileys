...
// ⚡ SPEED OPTIMIZED CONNECTION CONFIG (ඔයාගේම file එකට ගැලපෙන සේ සැකසූ කොටස)
exports.DEFAULT_CONNECTION_CONFIG = {
    version: exports.version,
    browser: (0, browser_utils_1.Browsers)('Chrome'),
    waWebSocketUrl: 'wss://web.whatsapp.com/ws/chat',
    
    // Timeouts අඩු කර ඉක්මනින් reconnect වීමට සලස්වා ඇත
    ...
    // මැසේජ් ෆේල් වුවහොත් නැවත උත්සාහ කරන වාර ගණන 2කි
    maxMsgRetryCount: 2,
    
    // 🚀 SPEED FIX: පරණ මැසේජ් ලෝඩ් වී බොට් එක ලැග් වීම වළක්වයි
    fireInitQueries: false,
    auth: undefined,
    
    // අනවශ්‍ය බැක්ග්‍රවුන්ඩ් සර්වර් සිග්නල් අඩු කර ඇත
    markOnlineOnConnect: false,
    syncFullHistory: false,
    
    patchMessageBeforeSending: msg => msg,
    
    // 🚀 SPEED FIX: හිස්ට්‍රි මැසේජ් සින්ක් වීම සම්පූර්ණයෙන්ම නවතී
