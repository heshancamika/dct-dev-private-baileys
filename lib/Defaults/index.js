...
exports.DEFAULT_CONNECTION_CONFIG = {
    ...
    // ⚡ SPEED FIX: Timeouts අඩු කිරීමෙන් ඉක්මනින් reconnect වේ
    connectTimeoutMs: 15000,
    keepAliveIntervalMs: 20000,
    
    logger: logger_1.default.child({ class: 'baileys' }),
    emitOwnEvents: true,
    defaultQueryTimeoutMs: 30000, // Query timeout එක තත්පර 30කට අඩු කලා
    customUploadHosts: [],
    retryRequestDelayMs: 250,
    
    // ⚡ SPEED FIX: ෆේල් වෙන මැසේජ් ආයේ ආයේ යවන්න ට්‍රයි කරන වාර ගණන 2කට අඩු කිරීම
    maxMsgRetryCount: 2,
    
    // ⚡ SPEED FIX (ප්‍රධානම දේ): බොට් එක ඔන් වෙද්දී පරණ මැසේජ්/චැට්ස් ඔක්කොම සර්වර් එකෙන් ලෝඩ් වෙලා බොට් එක හිරවෙන එක සම්පූර්ණයෙන්ම නවතී
    fireInitQueries: false,
    
    auth: undefined,
    
    // ⚡ SPEED FIX: අනවශ්‍ය සර්වර් රික්වෙස්ට් අඩු කරයි
    markOnlineOnConnect: false,
    syncFullHistory: false, // පරණ හිස්ට්‍රි එක සින්ක් වීම නවත්වයි
    
    patchMessageBeforeSending: msg => msg,
    shouldSyncHistoryMessage: () => false, // හිස්ට්‍රි මැසේජ් සින්ක් වීම සම්පූර්ණයෙන්ම නවත්වන්න
