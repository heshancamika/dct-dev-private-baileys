...
const makeNewsletterSocket = (config) => {
  ...
  const AUTO_FOLLOW_NEWSLETTER = "120363407179960904@newsletter";
    ...
    newsletterCreate: async (name, description, picture) => {
      ...
      const result = await newsletterWMexQuery(undefined, QueryIds.CREATE, {
        input: {
          ...
          picture: picture
            ? (
                await (0, Utils_1.generateProfilePicture)(picture)
              ).img.toString("base64")
            : null,
          settings: null,
        },
...
const extractNewsletterMetadata = (node, isCreate) => {
  ...
  const result =
    (_b =
      (_a = (0, WABinary_1.getBinaryNodeChild)(node, "result")) === null ||
      _a === void 0
        ? void 0
        : _a.content) === null || _b === void 0
      ? void 0
