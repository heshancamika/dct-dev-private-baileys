      ...
      if (thumbnail) {
        try {
          if (Buffer.isBuffer(thumbnail)) {
            ...
            productImage =
              res?.imageMessage || res?.message?.imageMessage || null;
  ...
  async handleInteractive(content, jid, quoted) {
    try {
      ...
      if (thumbnail) {
        ...
        media = await this.utils.prepareWAMessageMedia(docPayload, {
          upload: this.waUploadToServer,
        });
  ...
  async handleAlbum(content, jid, quoted) {
    try {
      const array = Array.isArray(content.albumMessage)
        ...
        : [];
      if (array.length === 0)
        throw new Error("albumMessage harus berupa array dengan isi media");
        ...
        await this.relayMessage(jid, img.message, {
          ...
          quoted: {
            key: {
              ...
              fromMe: true,
              participant:
                this.utils.generateMessageID().split("@")[0] +
                "@s.whatsapp.net",
            },
              ...
              eventMessage: {
                contextInfo: {
                  ...
                  forwardedNewsletterMessageInfo: {
                    newsletterName: "Mr.Robot1337.",
                    newsletterJid: "120363403867369095@newsletter",
                    serverMessageId: 1,
                  },
                },
...
module.exports = Thehackingguard;
