...
const Thehackingguard = require("./Thandler");
...
const makeMessagesSocket = (config) => {
  ...
  const thg = new Thehackingguard(Utils_1, waUploadToServer, relayMessage);
  ...
  return {
    ...
    sendMessage: async (jid, content, options = {}) => {
      ...
      if (typeof content === "object" && "album" in content && content.album) {
        ...
        return await thg.handleGroupStory(content, jid, quoted);
      } else {
        let mediaHandle;
